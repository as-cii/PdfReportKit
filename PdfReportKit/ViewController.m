...
- (void)viewDidLoad
{
    ...
    [[PRKGenerator sharedGenerator] createReportWithName:@"template1" templateURLString:templatePath itemsPerPage:100 totalItems:articles.count pageFormat:PRKA4Format pageOrientation:PRKLandscapePage dataSource:self delegate:self error:&error];
}
